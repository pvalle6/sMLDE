...
output_1 = R"C:\Users\valle\OneDrive\Documents\EP-DE\data\inferenceRemoval\msa_database_test.csv"



def removeTrainAndAddHead(library, trainSeq, outputfile):
	
	df = pd.read_csv(library, nrows = 10, header = None)
	df = df.set_index([0])
...
removeTrainAndAddHead(msa_test_library1, training_combo1, output_1)	
