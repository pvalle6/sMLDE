...
input_file = R"C:\Users\valle\OneDrive\Documents\EP-DE\data\149Thousand_AAGeorgiev.npy"
output_file = R"C:\Users\valle\OneDrive\Documents\EP-DE\data\test\Reduced149Thousand_AAGeorgiev__.csv"
...
#normalize data
flatArray = TwoDeeReduction(HighDimArray)
# normalization

scaler = StandardScaler()
standardizedData = scaler.fit_transform(flatArray)
