...
np.savetxt(R"C:\Users\valle\OneDrive\Documents\Class Documents\Research\pythonScripts\reducedDim\200onehotreduced.csv", printed_out_georgiev, fmt = '%.18f', delimiter =',')
